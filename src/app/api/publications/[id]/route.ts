...
export async function PATCH(
  ...
  try {
    ...
    const updated = await updatePublication(id, parsed.data);
    return NextResponse.json({ message: "Publicación actualizada exitosamente.", publication: updated }, { status: 200 });
  } catch (error) {
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ message: "Publicación eliminada exitosamente." }, { status: 200 });
  } catch (error) {
