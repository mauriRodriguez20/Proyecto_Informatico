...
const ratePublicationLegacySchema = z.object({
  rating: z
    .number({
...
export async function POST(
  ...
  try {
    ...
    const validation = ratePublicationLegacySchema.safeParse(body);
    ...
    const result = await ratePublication(idValidation.data, userId, {
    ...
    console.error("[POST /api/publications/:id/rate]", err.message);
