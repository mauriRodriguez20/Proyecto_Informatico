                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-xl text-white/40 font-light max-w-md">
                                Únete a miles de desarrolladores que comparten sus mejores soluciones y aprenden de los mejores expertos del sector.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                                ...
                                <div className="text-xs text-white/40 uppercase tracking-widest">Resolución de Bugs</div>
                            </div>
                            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
